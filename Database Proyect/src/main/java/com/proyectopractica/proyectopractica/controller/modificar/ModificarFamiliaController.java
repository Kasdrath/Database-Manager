...
public class ModificarFamiliaController {
    ...
    @FXML
    private TextField modificarfamiliatf;
   ...
   /* @FXML
    ...
    @FXML
    void modificarFamilia(ActionEvent event) throws IOException {
        if (modificarfamiliatf.getText().trim().isEmpty()) { //VER QUE TEXTFIELD NO ESTE VACIO
            ...
            try {
                ...
                while (rs.next()){
                    if(modificarfamiliatf.getText().equals(rs.getString("familia_name"))){ //COMPRUEBA QUE NO AGREGE UN NOMBRE QUE YA ESTE
                        FXMLLoader fxmlLoader = new FXMLLoader(Inicio.class.getResource("Error.fxml"));
                        Scene scene = new Scene(fxmlLoader.load(), 356, 113);
                        Stage stage = new Stage();
                        stage.setTitle("ERROR");
                ...
                stmt.executeUpdate("update familia set familia_name ="+"'"+modificarfamiliatf.getText()+"'"+"where familia_id ="+idfam+";");
